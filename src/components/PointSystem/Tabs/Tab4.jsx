...
const Tab4 = () => {
    const BattingPoints = [
        ...
        { text: "Strike rate 0 to 24.99"},
        { text: "Strike rate 25 to 49.99"},
        { text: "Strike rate 50 to 74.99"},
        { text: "Strike rate 75 to 99.99"},
        { text: "Strike rate 100.00 to 124.99"},
        { text: "Strike rate 125 to 149.99"},
        { text: "Strike rate 150.00 or more"},
      ];
      ...
      const BowlingPoints = [
        ...
        { text: "Economy rate 0 to 3.00"},
        { text: "Economy rate 3.01 to 5.00"},
        { text: "Economy rate 5.01 to 7.00"},
        { text: "Economy rate 7.01 to 9.00"},
        { text: "Economy rate 9.01 to 11.00"},
        { text: "Economy rate 11.01 or above"},
        { text: "Bowled/LBW"},
      ];
