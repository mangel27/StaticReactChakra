    ...
    <>
      ...
      <Center>
        <Text fontSize={"sm"} p={5}>
          * For a Run Out fielder hitting the stump and last assist would be
          rewarded equal points
        </Text>
      </Center>
    </>
  );
